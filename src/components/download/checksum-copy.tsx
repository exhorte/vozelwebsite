...
export function ChecksumCopy() {
  ...
  return (
    <div className="w-full max-w-sm mx-auto mt-6">
      <h4 className="text-xs tracking-[0.15em] uppercase text-vozel-muted-dark font-medium mb-2 text-center">
        Checksum SHA-256
      </h4>
      <div className="flex items-center gap-2 bg-vozel-surface border border-vozel-border-dark rounded-md p-3">
        <code className="flex-1 text-xs text-vozel-muted-dark/80 font-mono break-all">
        ...
        <button
          ...
          onClick={handleCopy}
          className={cx(
            "shrink-0 flex items-center gap-1.5 text-xs transition-colors rounded-sm px-2 py-1 focus-visible:outline-2 focus-visible:outline-vozel-focus",
            copied
              ? "text-vozel-success"
