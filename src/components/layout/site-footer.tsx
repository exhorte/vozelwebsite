 ...
 * Minimal dark footer.
 *
 * Inspired by the Fluent brand guide: logo, tagline,
 * navigation, and copyright — nothing extraneous.
 */
export function SiteFooter() {
  return (
    <footer className="bg-fluent-ink border-t border-fluent-border-dark">
      <div className="mx-auto max-w-[var(--content-max)] px-6 py-16 sm:py-20">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-fluent-muted-dark font-[family-name:var(--font-the-seasons)] italic">
              {siteConfig.tagline}
            </p>
          </div>
        ...
        {/* Bottom section */}
        <p className="text-xs text-fluent-muted-dark">
