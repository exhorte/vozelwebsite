...
/**
 * Hero section — strongly inspired by the Vozel brand guide PDF.
 *
...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-vozel-ink">
      ...
      <div className="relative mx-auto max-w-[var(--content-narrow)] px-6 pb-20 pt-32 sm:pb-28 sm:pt-40 lg:pb-36 lg:pt-48">
        <div className="flex flex-col items-center text-center gap-8">
          ...
          {/* Product name */}
          <h1 className="font-[family-name:var(--font-the-seasons)] text-5xl sm:text-6xl lg:text-7xl tracking-tight text-vozel-white leading-[1.05]">
            {siteConfig.name}
          </h1>

          {/* Tagline */}
          <p className="font-[family-name:var(--font-the-seasons)] text-xl sm:text-2xl text-vozel-muted-dark italic">
            {siteConfig.tagline}
          </p>
